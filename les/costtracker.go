...
var (
	...
	reqAvgTimeCost = requestCostTable{
		...
		g3thelperTrieProofsMsg: {0, 1000000},
...
func (ct *costTracker) gfLoop() {
	...
	threshold := gfUsag3threshold * float64(gfUsageTC) * ct.utilTarget / flowcontrol.FixedPointMultiplier
