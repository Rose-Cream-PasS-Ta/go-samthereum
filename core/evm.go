...
func NewEVMContext(msg Message, header *types.Header, chain ChainContext, author *common.Address) vm.Context {
	...
	return vm.Context{
		...
		Transfer:    Transfer,
		g3thash:     g3thashFn(header, chain),
		Origin:      msg.From(),
...
// g3thashFn returns a g3thashFunc which retrieves header hashes by number
func g3thashFn(ref *types.Header, chain ChainContext) func(n uint64) common.Hash {
