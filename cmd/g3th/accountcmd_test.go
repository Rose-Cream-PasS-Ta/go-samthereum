...
func TestAccountListEmpty(t *testing.T) {
	g3th := runGMC(t, "account", "list")
	g3th.ExpectExit()
}

func TestAccountList(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	g3th := runGMC(t, "account", "list", "--datadir", datadir)
...
func TestAccountNew(t *testing.T) {
	g3th := runGMC(t, "account", "new", "--lightkdf")
	defer g3th.ExpectExit()
	g3th.Expect(`
...
`)
	g3th.ExpectRegexp(`Address: \{[0-9a-f]{40}\}\n`)
}
...
func TestWalletImport(t *testing.T) {
	g3th := runGMC(t, "wallet", "import", "--lightkdf", "testdata/guswallet.json")
	defer g3th.ExpectExit()
	g3th.Expect(`
!! Unsupported terminal, password will be echoed.
