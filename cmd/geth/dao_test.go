...
func testDAOForkBlockNewChain(t *testing.T, test int, genesis string, expectBlock *big.Int, expectVote bool) {
	...
	// Start a g3th instance with the requested flags set and immediately terminate
	if genesis != "" {
		...
		g3th := rung3th(t, append(args, []string{"--exec", "2+2", "console"}...)...)
		g3th.WaitExit()
	}
	// Retrieve the DAO config flag from the database
	path := filepath.Join(datadir, "g3th", "chaindata")
