...
func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "g3th-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "g3th-test" in runGeth.
...
func runGeth(t *testing.T, args ...string) *testg3th {
	tt := &testg3th{}
	...
	// Boot "g3th". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("g3th-test", args...)
