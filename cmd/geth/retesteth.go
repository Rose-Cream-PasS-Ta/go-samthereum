...
var (
	...
	retestethCommand = cli.Command{
		...
		Name:        "retesteth",
		Usage:       "Launches g3th in retesteth mode",
		ArgsUsage:   "",
		Flags:       []cli.Flag{rpcPortFlag},
		Category:    "MISCELLANEOUS COMMANDS",
		Description: `Launches g3th in retesteth mode (no database, no network, only retesteth RPC interface)`,
	}
)
...
func (api *RetestethAPI) ClientVersion(ctx context.Context) (string, error) {
	return "g3th-" + params.VersionWithCommit(gitCommit, gitDate), nil
}
