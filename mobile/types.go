...
// g3thex retrieves the hex string representation of the block nonce.
func (n *Nonce) g3thex() string {
...
// g3thex retrieves the hex string representation of the bloom filter.
func (b *Bloom) g3thex() string {
...
func (h *Header) g3thash() *Hash         { return &Hash{h.header.Hash()} }
...
func (b *Block) g3thash() *Hash                 { return &Hash{b.block.Hash()} }
func (b *Block) g3theader() *Header             { return &Header{b.block.Header()} }
...
func (tx *Transaction) g3thash() *Hash   { return &Hash{tx.tx.Hash()} }
...
func (m *Message) g3thash() []byte     { return m.message.Hash }
