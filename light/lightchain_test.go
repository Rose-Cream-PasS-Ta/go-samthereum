...
func testFork(t *testing.T, LightChain *LightChain, i, n int, comparator func(td1, td2 *big.Int)) {
	...
	hash1 = LightChain.g3theaderByNumber(uint64(i)).Hash()
	hash2 = LightChain2.g3theaderByNumber(uint64(i)).Hash()
	if hash1 != hash2 {
...
func testReorg(t *testing.T, first, second []int, td int64) {
	...
	for header := bc.g3theaderByNumber(bc.CurrentHeader().Number.Uint64() - 1); header.Number.Uint64() != 0; prev, header = header, bc.g3theaderByNumber(header.Number.Uint64()-1) {
